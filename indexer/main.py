...
f = fls[0] # TO BE PROPERLY IMPLEMENTED LATER
...
transformed = transformed[ycut:img.shape[0], 0:img.shape[1]//2 - 250]
...
for first_center, second_center, i in zip(sorted_centers, sorted_centers[1:], count()):
    ...
    dist = sqrt((center_y2-center_y1)**2 + (center_x2-center_x1)**2) * canonical # px to mm
